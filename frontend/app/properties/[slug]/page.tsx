...
export default function PropertyDetailPage() {
  ...
  useEffect(() => {
    api.get(`/properties/types/${params.slug}/`)
      .then((res) => {
  ...
  useEffect(() => {
    if (form.check_in && form.check_out && property) {
      ...
      if (diff > 0) {
        ...
        setTotalPrice(base + tax + service);
      } else {
        setNights(0);
        setTotalPrice(0);
      }
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2">
          ...
          {!activeImage && (
            <div className="h-80 w-full mb-6 bg-teal-100 rounded-xl flex items-center justify-center text-6xl">🏨</div>
          )}
        ...
        <div>
          <div className="bg-white rounded-xl shadow-lg p-6 sticky top-24">
            ...
            <p className="text-xs text-gray-400 mb-4">
              +11% tax +5% service charge applies
            </p>
